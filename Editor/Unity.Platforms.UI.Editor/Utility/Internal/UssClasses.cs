namespace Unity.Platforms.UI
{
    ...
    {
        const string Base = "unity-platforms";
        ...
        public static class RuntimeBarElement
        {
            public const string RuntimeBar = Base + "__runtime-bar";
            public const string RuntimeBarAdded = Base + "__runtime-bar-added";
        }
    }
}
